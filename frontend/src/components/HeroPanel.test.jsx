...
describe('HeroPanel', () => {
  ...
  it('renders combat buttons correctly', () => {
    render(<HeroPanel {...mockProps} inCombat={true} hasSpecialMoves={true} hasDefensiveMoves={true} />);
  ...
  it('hides special and defensive buttons in combat if not available', () => {
    render(<HeroPanel {...mockProps} inCombat={true} hasSpecialMoves={false} hasDefensiveMoves={false} />);
