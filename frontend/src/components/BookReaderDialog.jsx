      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              padding: '7px 18px',
              backgroundColor: safePageIdx === 0 ? 'transparent' : '#001833',
              color: safePageIdx === 0 ? 'rgba(0, 204, 255, 0.25)' : '#00ccff',
              border: `1px solid ${safePageIdx === 0 ? 'rgba(0, 204, 255, 0.15)' : '#00ccff'}`,
              borderRadius: '3px',
          ...
          <button
            ...
            style={{
              padding: '7px 18px',
              backgroundColor: safePageIdx === totalPages - 1 ? 'transparent' : '#001833',
              color: safePageIdx === totalPages - 1 ? 'rgba(0, 204, 255, 0.25)' : '#00ccff',
              border: `1px solid ${safePageIdx === totalPages - 1 ? 'rgba(0, 204, 255, 0.15)' : '#00ccff'}`,
              borderRadius: '3px',
