...
## idle -- deliver as `giantspider__idle.png` (3 rows x 4 cols)

```text
SUBJECT: A giant cave spider the size of a large dog: black bristling wiry hair, eight long jointed legs, a cluster of gleaming eyes, sharp mandibles dripping faintly glowing green venom. Attacks with a rearing bite; dies curled on its back. Accent colour: toxic green drool.
...
## walk -- deliver as `giantspider__walk.png` (3 rows x 6 cols)
...
## attack -- deliver as `giantspider__attack.png` (3 rows x 6 cols)
...
## cast -- deliver as `giantspider__cast.png` (3 rows x 6 cols)
...
## defend -- deliver as `giantspider__defend.png` (3 rows x 4 cols)
...
## hurt -- deliver as `giantspider__hurt.png` (3 rows x 3 cols)
...
## death -- deliver as `giantspider__death.png` (3 rows x 6 cols)
