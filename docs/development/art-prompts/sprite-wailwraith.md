# Sprite sheets: Wail Wraith (boss)
...
## idle -- deliver as `wailwraith__idle.png` (3 rows x 4 cols)

```text
SUBJECT: A Wail Wraith: a ragged shape woven from sound and absence, more heard than seen -- no stable silhouette, edges blurring like heat haze, briefly cohering into a hooded near-humanoid form then fraying. Dust-grey and rust, no eyes or face. It does not walk; it drifts. Attack is a keening lunge, cast is a spreading toll, death is unravelling into threads of dust. Accent colour: dust-grey with rust.
...
## walk -- deliver as `wailwraith__walk.png` (3 rows x 6 cols)
...
## attack -- deliver as `wailwraith__attack.png` (3 rows x 6 cols)
...
## cast -- deliver as `wailwraith__cast.png` (3 rows x 6 cols)
...
## defend -- deliver as `wailwraith__defend.png` (3 rows x 4 cols)
...
## hurt -- deliver as `wailwraith__hurt.png` (3 rows x 3 cols)
...
## death -- deliver as `wailwraith__death.png` (3 rows x 6 cols)
