...
## idle -- deliver as `lurker__idle.png` (3 rows x 4 cols)

```text
SUBJECT: A Lurker: a grisly demon of the dark, vaguely humanoid and wrong in proportion -- elongated torso, long thin arms ending in hooked poisonous claws, hunched, skin like wet charcoal, faintly glowing sickly-yellow eyes, no other features. Attacks with a raking double-claw swipe; casts by spreading its arms in a shroud of darkness; dies folding in on itself. Accent colour: sickly yellow eyes.
...
## walk -- deliver as `lurker__walk.png` (3 rows x 6 cols)
...
## attack -- deliver as `lurker__attack.png` (3 rows x 6 cols)
...
## cast -- deliver as `lurker__cast.png` (3 rows x 6 cols)
...
## defend -- deliver as `lurker__defend.png` (3 rows x 4 cols)
...
## hurt -- deliver as `lurker__hurt.png` (3 rows x 3 cols)
...
## death -- deliver as `lurker__death.png` (3 rows x 6 cols)
