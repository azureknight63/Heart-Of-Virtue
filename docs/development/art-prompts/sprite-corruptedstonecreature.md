# Sprite sheets: Corrupted Stone Creature
...
## idle -- deliver as `corruptedstonecreature__idle.png` (3 rows x 4 cols)

```text
SUBJECT: A Corrupted Stone Creature: a lurching vaguely humanoid mass of pebbles, rock fragments and crystalline shards loosely bound in a grey slurry streaked with sickly iridescent green; no face, though one fragment might be an eye. It trails slurry as it moves. Attacks with a heavy overhand slam; casts by grinding and swelling; dies by falling apart into a pile of stones. Accent colour: sick iridescent green slurry.
...
## walk -- deliver as `corruptedstonecreature__walk.png` (3 rows x 6 cols)
...
## attack -- deliver as `corruptedstonecreature__attack.png` (3 rows x 6 cols)
...
## cast -- deliver as `corruptedstonecreature__cast.png` (3 rows x 6 cols)
...
## defend -- deliver as `corruptedstonecreature__defend.png` (3 rows x 4 cols)
...
## hurt -- deliver as `corruptedstonecreature__hurt.png` (3 rows x 3 cols)
...
## death -- deliver as `corruptedstonecreature__death.png` (3 rows x 6 cols)
