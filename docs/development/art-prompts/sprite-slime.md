...
## idle -- deliver as `slime__idle.png` (3 rows x 4 cols)

```text
SUBJECT: A common cave slime: a knee-high amorphous gelatinous blob, translucent pale to murky green, no limbs or face, surface rippling into pseudopod bulges; small swallowed pebbles and insect chitin visible suspended inside it. It attacks by surging forward and slapping with a pseudopod; it casts by swelling; it dies by deflating into a puddle. Accent colour: murky green.
...
## walk -- deliver as `slime__walk.png` (3 rows x 6 cols)
...
## attack -- deliver as `slime__attack.png` (3 rows x 6 cols)
...
## cast -- deliver as `slime__cast.png` (3 rows x 6 cols)
...
## defend -- deliver as `slime__defend.png` (3 rows x 4 cols)
...
## hurt -- deliver as `slime__hurt.png` (3 rows x 3 cols)
...
## death -- deliver as `slime__death.png` (3 rows x 6 cols)
