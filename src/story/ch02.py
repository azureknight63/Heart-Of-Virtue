    ...
    def process(self):
        if not self.player.skip_dialog:
            ...
            print(
                ...
                "Gorran led Jean through the cavern, "
                "pointing out various features of the Grondite settlement as they went."
            )
            time.sleep(2)
            print(
            ...
            print(
                ...
                "The floor was covered in a thick layer of moss, and the air was filled with the sound of dripping water "
            ...
            time.sleep(2)
            print(
                "With that, a rolling rumble of laughter erupted from the elder's mouth like the aftershocks of an earthquake."
            )
            time.sleep(2)
            dialogue(
                "Votha Krr",
            ...
            time.sleep(2)
            print(
                "Jean paused for a long moment, unsure of how to answer. If he was honest with himself, he didn't "
                "really know how to answer any of those questions. He furrowed his brow, troubled by this sudden "
                "consternation. He took a deep breath, trying to gather his thoughts."
            )
            time.sleep(3)
            dialogue("Jean", "I am Jean. Jean Claire.", "cyan")
            time.sleep(1)
            print("He stopped there. Votha Krr waited, unhurried as erosion.")
            time.sleep(2)
            dialogue(
                "Jean",
            ...
            time.sleep(1)
            print("He tilted his great head, just slightly.")
            time.sleep(1)
            dialogue(
                "Votha Krr",
            ...
            time.sleep(2)
            print("Jean opened his mouth. Closed it. The chamber was very quiet.")
            time.sleep(2)
            ...
            time.sleep(1.5)
            print("He watched Jean's face. Jean wasn't showing much.")
            time.sleep(1)
            ...
            if _quest_choice == "a":
                time.sleep(1)
                print("Votha Krr's expression darkened, and he continued.")
                time.sleep(1)
                dialogue(
                    "Votha Krr",
                ...
                time.sleep(1)
                print("He didn't ask himself why he was so sure of that.")
                time.sleep(2)
        ...
        if not self.player.skip_dialog:
            print(
                "Votha Krr waved a hand, and a Grondite attendant stepped forward, carrying a small bundle of supplies."
            )
            print("The attendant handed the bundle to Jean, who took it gratefully.")
