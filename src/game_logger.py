...
class GameLogger:
    ...
    def log_distance_calculation(
        self, unit1: str, unit2: str, distance: float, details: str = None
    ) -> None:
    ...
    def log_angle_calculation(
        self, observer: str, target: str, angle: float, quadrant: str = None
    ) -> None:
    ...
    def log_combat_event(
        self, event_name: str, participants: list = None, outcome: str = None
    ) -> None:
