    ...
    def handle_choice(self, idx: int):
        ...
        if hasattr(item, "count"):
            ...
            if get_gold(self.shop.player.inventory) >= price:
                transfer_gold(
                    self.shop.player.inventory,
                    self.shop.merchant.inventory,
                    price,
                )
...
# so existing terminal menu classes (below) keep working unchanged.
from inventory_utils import get_gold, transfer_gold, transfer_item  # noqa: F401,E402
