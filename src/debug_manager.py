...
class DebugManager:
    ...
    def log_command(
        self, command_name: str, args: List[str] = None, result: str = ""
    ) -> None:
        ...
        entry = {"command": command_name, "args": args or [], "result": result}
    ...
    def cmd_spawn_enemy(self, enemy_name: str = "", count: int = 1) -> str:
        ...
        self.log_command(
            "spawn_enemy",
            args=[enemy_name, str(count)],
            result=f"Spawned {count} {enemy_name}",
        )
    ...
    def display_ai_debug_info(
        self, npc: Any, decision: str, details: Dict[str, Any] = None
    ) -> None:
