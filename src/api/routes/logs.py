...
def cleanup_logs():
    ...
    try:
        ...
        max_size_mb = data.get('max_size_mb', cleanup_manager.max_size_bytes / (1024 * 1024))
        
        temp_manager = LogCleanupManager(LOGS_DIR, retention_days=retention_days, max_size_mb=max_size_mb)
