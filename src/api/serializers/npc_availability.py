...
class NPCLocationSerializer:
    ...
    @staticmethod
    def get_location(npc_data: Dict, game_tick: int, player_story: Dict) -> Optional[Dict]:
        """
    ...
    @staticmethod
    def is_at_location(npc_id: str, location_id: str, npc_data: Dict, 
                      game_tick: int, player_story: Dict) -> bool:
        """Check if an NPC is at a specific location right now."""
        current_location = NPCLocationSerializer.get_location(npc_data, game_tick, player_story)
...
class NPCAvailabilitySerializer:
    ...
    @staticmethod
    def check_story_gates(npc_data: Dict, player_story: Dict) -> Tuple[bool, Optional[str]]:
        """
        ...
        """
        required_gates = npc_data.get("availability_conditions", {}).get("story_gates", [])
    ...
    @staticmethod
    def check_tick_requirements(npc_data: Dict, game_tick: int, 
                               gate_completion_tick: int = 0) -> Tuple[bool, Optional[int]]:
        """
        ...
        """
        min_ticks_after_gate = npc_data.get("availability_conditions", {}).get("min_ticks_after_gate", 0)
    ...
    @staticmethod
    def is_available(npc_data: Dict, game_tick: int, player_story: Dict,
                    gate_completion_tick: int = 0) -> Tuple[bool, AvailabilityReason]:
        """
        ...
        """
        # Check story gates
        gates_met, missing_gate = NPCAvailabilitySerializer.check_story_gates(npc_data, player_story)
        if not gates_met:
    ...
    @staticmethod
    def serialize(npc_data: Dict, game_tick: int, player_story: Dict,
                 gate_completion_tick: int = 0) -> Dict:
        """
...
class LocationNPCSerializer:
    ...
    @staticmethod
    def get_npcs_at_location(location_id: str, all_npcs: List[Dict], 
                            game_tick: int, player_story: Dict) -> List[Dict]:
        """
    ...
    @staticmethod
    def serialize(location_id: str, location_name: str, all_npcs: List[Dict],
                 game_tick: int, player_story: Dict) -> Dict:
        """
...
class NPCEventTriggerSerializer:
    ...
    @staticmethod
    def check_trigger_conditions(trigger_data: Dict, game_tick: int,
                                player_story: Dict) -> bool:
        """
    ...
    @staticmethod
    def get_active_triggers(npc_data: Dict, game_tick: int,
                           player_story: Dict) -> List[Dict]:
        """
...
class NPCStatusSerializer:
    ...
    @staticmethod
    def serialize(npc_data: Dict, game_tick: int, player_story: Dict,
                 gate_completion_ticks: Optional[Dict] = None) -> Dict:
        """
