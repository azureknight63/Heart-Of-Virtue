...
class LogCleanupManager:
    ...
    def cleanup(self):
        ...
        return {
            ...
            "total_deleted_count": age_result["deleted_count"]
            + size_result["deleted_count"],
            "total_deleted_size_mb": age_result.get("deleted_size_mb", 0)
            + size_result.get("deleted_size_mb", 0),
        }
